...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String COL_3 = "PreviousKharcha";
    public static final String COL_4 = "CurrentKharcha";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(" create table " + TABLE_NAME + " ( ID STRING PRIMARY KEY, KharchaType STRING , PreviousKharcha INTEGER, CurrentKharcha INTEGER ) " );
    }
...
db.execSQL("Update "+TABLE_NAME+" set "+ COL_3 +" = "+ COL_4);
    ...
    public boolean insertData(String ID, String KharchaType, Integer PreviousKharcha,Integer CurrentKharcha){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();

        contentValues.put(COL_1,ID);
        contentValues.put(COL_2,KharchaType);
        contentValues.put(COL_3,PreviousKharcha);
        contentValues.put(COL_4,CurrentKharcha);
...
if(result == -1)
    ...
    public boolean updateData(String ID, String KharchaType, Integer PreviousKharcha, Integer CurrentKharcha){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
